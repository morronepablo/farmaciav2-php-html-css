$(document).ready(function () {
    ...
    let template = `
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li id="" class="nav-item">
                    <a href="/farmaciav2/Views/presentaciones.php" class="active nav-link">
  ...
  async function obtener_presentaciones() {
    ...
    if (data.ok) {
      let response = await data.text();
      try {
        let presentaciones = JSON.parse(response);
    ...
    if (data.ok) {
      ...
      try {
        ...
        if (respuesta.mensaje == "success") {
          toastr.success(
            "Se ha creado la presentación correctamente",
            "Exito!",
            { timeOut: 2000 }
          );
          obtener_presentaciones();
  ...
  async function editar_presentacion(datos) {
    ...
    if (data.ok) {
      ...
      try {
        ...
        if (respuesta.mensaje == "success") {
          toastr.success(
            "Se ha editado la presentación correctamente",
            "Exito!",
            { timeOut: 2000 }
          );
          obtener_presentaciones();
