  ...
  async function obtener_lotes() {
    ...
    if (data.ok) {
      ...
      try {
        ...
        //         let tiempo = `Falta ${datos.year} años, ${datos.mes} meses y ${datos.dia} días`;
        ...
        //         // Combinar las partes con "y" antes del último elemento si hay más de una parte
        //         let tiempoTexto = "";
        //         if (tiempoPartes.length === 0) {
        //           tiempoTexto = "Vence hoy"; // Caso especial si year, mes y dia son 0
        ...
        //         // Determinar si es "Falta" o "Vencido"
        //         let tiempo =
        //           datos.estado === "danger"
        //             ? `Vencido ${tiempoTexto}`
        //             : `Falta ${tiempoTexto}`;
