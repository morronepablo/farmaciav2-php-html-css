...
<body class="sidebar-mini layout-navbar-fixed layout-fixed layout-footer-fixed accent-success" style="height: auto;">
    ...
    <div class="wrapper">
        ...
        <!-- Control Sidebar -->
        <aside class="control-sidebar control-sidebar-dark" style="display: block; bottom: 57.1007px; top: 57.0833px;">
            <!-- Control sidebar content goes here -->
            <div class="p-3 control-sidebar-content" style="height: 100%;">
                ...
                <div class="d-flex"><select class="custom-select mb-3 text-light border-0 bg-success">
                ...
                <div class="d-flex"></div><select class="custom-select mb-3 text-light border-0 bg-success">
                    <option>None Selected</option>
                    <option class="bg-primary">Primary</option>
                    <option class="bg-warning">Warning</option>
                    <option class="bg-info">Info</option>
                ...
                <div class="d-flex"></div><select class="custom-select mb-3 border-0 bg-success text-light">
                    <option>None Selected</option>
                    <option class="bg-primary">Primary</option>
                    <option class="bg-secondary">Secondary</option>
                    <option class="bg-info">Info</option>
