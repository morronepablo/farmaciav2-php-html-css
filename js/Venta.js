$(document).ready(function(){
    ...
    function mostrar_consultas(){
        ...
        $.post('../controlador/VentaController.php',{funcion},(response)=>{
            ...
            if(vistas.venta_dia_vendedor==null){
                vistas.venta_dia_vendedor=0;
            }
            if(vistas.venta_diaria==null){
                vistas.venta_diaria=0;
            }
            if(vistas.venta_mensual==null){
                vistas.venta_mensual=0;
            }
            if(vistas.venta_anual==null){
                vistas.venta_anual=0;
            }
    ...
    $('#tabla_venta tbody').on('click','.borrar',function(){
        ...
        const swalWithBootstrapButtons = Swal.mixin({
            ...
            swalWithBootstrapButtons.fire({
                ...
                text: "Y no podrás revertir esto!",
                icon: 'warning',
