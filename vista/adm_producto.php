 ...
 ?>
  ...
  <?php
   ...
   ?>
	 ...
	 <div class="animate__animated animate__zoomInDown modal fade" id="modalFormatoReporte" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	   <div class="modal-dialog">
	     <div class="modal-content">
	         <div class="card card-success">
	             <div class="card-header">
	                 <h3 class="card-title">Elejir formato de reporte</h3>
...
<!------------------------------------->
<div class="animate__animated animate__zoomInDown modal fade" id="crearproducto" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="card card-success">
            <div class="card-header">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="animate__animated animate__fadeInRight">Gestion producto<button id="button-crear" type="button" data-toggle="modal" data-target="#crearproducto" class="btn bg-gradient-primary ml-2">Crear producto</button><button type="button" data-toggle="modal" data-target="#modalFormatoReporte" class="btn bg-gradient-success ml-2">Reporte de productos</button>
						</h1>
          </div>
          <div class="col-sm-6">
